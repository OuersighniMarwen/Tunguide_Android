...
public class ActActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add = findViewById(R.id.add_act);
        name = findViewById(R.id.act_name);
        adresse = findViewById(R.id.act_adresse);
        price = findViewById(R.id.act_price);
        upload_image = findViewById(R.id.upload_act);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<ResponseBody> call = RetrofitClient.getInstance().getApi().addActivity(name.getText().toString(),
    ...
    boolean result;
    public boolean uploadActPhoto(MultipartBody.Part body)
    {
        result = false;
