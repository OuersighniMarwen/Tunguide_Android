...
import com.ouersighnimarwen.tunguidef.entity.Hotel;
import com.ouersighnimarwen.tunguidef.entity.MenuModel;
import com.ouersighnimarwen.tunguidef.entity.RetrofitClient;
import com.ouersighnimarwen.tunguidef.ui.activities.HotelActivity;
...
public class HotelsFragment extends Fragment {
    ...
    public HotelsFragment(Context context)
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        final RecyclerView recyclerViewH= view.findViewById(R.id.rvMenuH);


        addHotel = view.findViewById(R.id.add_hotel_image);
        ...
        Call<ResponseBody> call = RetrofitClient.getInstance().getApi().getHotels();
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    for(int i=0; i<jsonArray.length(); i++)
                    {
                        ...
                        Hotel h = new Hotel(jsonObject.getInt("hotel_id"),
                                jsonObject.getString("hotel_name"),
                                jsonObject.getString("hotel_adresse"),
                                jsonObject.getString("hotel_image"),
                                jsonObject.getInt("hotel_star"),
                        ...
                        recyclerViewH.setLayoutManager(horizontalLayoutManager);
                        recyclerViewH.setAdapter(menuAdapter);
                    }
