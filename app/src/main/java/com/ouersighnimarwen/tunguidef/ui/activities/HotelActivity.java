...
public class HotelActivity extends AppCompatActivity {
    ...
    EditText name,adresse,price,star;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add = findViewById(R.id.add_hotel);
        name = findViewById(R.id.hotel_name);
        adresse = findViewById(R.id.hotel_adresse);
        price = findViewById(R.id.hotel_price);
        star = findViewById(R.id.hotel_star);
        upload_image = findViewById(R.id.upload_hotel);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<ResponseBody> call = RetrofitClient.getInstance().getApi().AddHotel(name.getText().toString(),
    ...
    boolean result;
    public boolean uploadHotelPhoto(MultipartBody.Part body)
    {
        result = false;
